...
[![codecov](https://codecov.io/gh/pizzafox/renovate-config/branch/master/graph/badge.svg)](https://codecov.io/gh/pizzafox/renovate-config)
...
The CI will upload the coverage information to [CodeCov](https://codecov.io) which can be [viewed here](https://codecov.io/gh/pizzafox/renovate-config).
